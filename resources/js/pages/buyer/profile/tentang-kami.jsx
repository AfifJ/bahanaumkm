        ...
        <BuyerLayoutWrapper backLink={route('buyer.profile.index')} title="Tentang Kami">
            <div className="w-full p-4 pb-20 overflow-x-hidden">
                ...
                <div className="text-center mb-8 sm:mb-12">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900 mb-3 sm:mb-4">Tentang Bahana</h1>
                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 sm:p-8 mb-6 sm:mb-8 shadow-sm">
                    <h2 className="text-xl font-semibold text-gray-900 mb-3 sm:mb-4">Misi Kami</h2>
                ...
                <div className="mb-8 sm:mb-12">
                    <h2 className="text-xl font-semibold text-gray-900 mb-4 sm:mb-6 text-center">Bagaimana Kami Membantu UMKM</h2>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        <div className="bg-white border border-gray-100 rounded-xl p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow duration-300">
                            ...
                            <h3 className="text-base  font-semibold text-gray-900 mb-2">Akses Pasar yang Lebih Luas</h3>
                        ...
                        <div className="bg-white border border-gray-100 rounded-xl p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow duration-300">
                            ...
                            <h3 className="text-base  font-semibold text-gray-900 mb-2">Sistem yang Aman</h3>
                            <p className="text-sm  text-gray-600 leading-relaxed">
                        ...
                        <div className="bg-white border border-gray-100 rounded-xl p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow duration-300">
                            ...
                            <h3 className="text-base  font-semibold text-gray-900 mb-2">Analitik Real-time</h3>
                            <p className="text-sm  text-gray-600 leading-relaxed">
                        ...
                        <div className="bg-white border border-gray-100 rounded-xl p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow duration-300">
                            ...
                            <h3 className="text-base  font-semibold text-gray-900 mb-2">Komunitas yang Mendukung</h3>
                            <p className="text-sm  text-gray-600 leading-relaxed">
                ...
                <div className="mb-6 sm:mb-8">
                    <h2 className="text-xl  font-semibold text-gray-900 mb-4 sm:mb-6 text-center">Nilai-nilai Kami</h2>
                    <div className="space-y-4">
                        <div className="flex items-start bg-white rounded-xl p-4 shadow-sm">
                            ...
                            <div>
                                <h3 className="text-base  font-semibold text-gray-900 mb-1">Keberlanjutan</h3>
                                <p className="text-sm  text-gray-600">Mendorong pertumbuhan UMKM yang berkelanjutan dan berdampak positif bagi ekonomi lokal.</p>
                            </div>
                        </div>
                        <div className="flex items-start bg-white rounded-xl p-4 shadow-sm">
                            ...
                            <div>
                                <h3 className="text-base  font-semibold text-gray-900 mb-1">Kolaborasi</h3>
                                <p className="text-sm  text-gray-600">Membangun ekosistem yang saling menguntungkan antara UMKM, mitra hotel, dan konsumen.</p>
                            </div>
                        </div>
                        <div className="flex items-start bg-white rounded-xl p-4 shadow-sm">
                            ...
                            <div>
                                <h3 className="text-base  font-semibold text-gray-900 mb-1">Inovasi</h3>
                                <p className="text-sm  text-gray-600">Terus mengembangkan teknologi untuk memudahkan UMKM dalam berbisnis digital.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {/* CTA Section */}
                <div className="bg-primary rounded-2xl p-6 sm:p-8 text-center text-white shadow-lg">
                    <h2 className="text-xl  font-bold mb-3 sm:mb-4">Bergabunglah dengan Bahana</h2>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                        <Button className="bg-white text-primary px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg font-semibold hover:bg-blue-50 transition-colors shadow-sm text-sm  min-w-0">
                            Daftar sebagai UMKM
                        </Button>
                        <Button variant="outline" className="border border-white text-primary px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg font-semibold hover:bg-white hover:text-blue-600 transition-colors text-sm  min-w-0">
